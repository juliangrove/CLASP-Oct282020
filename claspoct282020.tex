...
\label{sec:orgde1b4f6}

\begin{frame}[label={sec:org4764e71}]{We are here}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:org6a8ed1d}]{Semantics}
...
\begin{frame}[label={sec:orge9ec991}]{Montague}
\begin{center}
...
\begin{frame}[label={sec:orge587af5}]{Functional application}
...
\begin{frame}[label={sec:org2632636}]{Quantifying in}
\begin{center}
...
\begin{frame}[label={sec:org8965f60}]{Quantifying in}
...
\begin{frame}[label={sec:orgb26fa69}]{Since then}
...
\begin{frame}[label={sec:org79ff91f}]{The Monad Laws}
\begin{align*}
...
\begin{frame}[label={sec:org58b8366}]{First case: quantification}
...
\begin{frame}[label={sec:org2982c04},t]{How it works}
\begin{enumerate}
...
\begin{frame}[label={sec:org2c79665}]{Summary}
...
\begin{frame}[label={sec:orgb0379a0}]{Second case: anaphora}
...
\begin{frame}[label={sec:org1c20140},t]{How it works}
\begin{enumerate}
...
\begin{frame}[label={sec:org3e51bcd}]{Summary}
...
\begin{frame}[label={sec:org035f727}]{Combining quantification and anaphora}
...
\begin{frame}[label={sec:org94a6ca5}]{Monad transformers}
...
\begin{frame}[label={sec:org3852739}]{The Continuation monad transformer}
\begin{columns}
...
\begin{frame}[label={sec:orgfa877dc}]{The problem}
...
\label{sec:org063b324}

\begin{frame}[label={sec:org7f88dcf}]{We are here}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:orga8ad69f}]{Background}
...
\begin{frame}[label={sec:org4135417}]{The basic idea}
...
\begin{frame}[label={sec:org840a91d}]{Algebraic signatures}
...
\begin{frame}[label={sec:orgabab1f0}]{Algebraic laws}
