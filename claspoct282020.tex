...
\label{sec:orgb85e956}

\begin{frame}[label={sec:orge6f5acf}]{We are here}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:orgadb03ff}]{Semantics}
...
\begin{frame}[label={sec:org200a02e}]{Montague}
\begin{center}
...
\begin{frame}[label={sec:org12a5583}]{Functional application}
...
\begin{frame}[label={sec:org0d46ade}]{Quantifying in}
\begin{center}
...
\begin{frame}[label={sec:org7003a0e}]{Quantifying in}
...
\begin{frame}[label={sec:orgd8d8278}]{Since then}
...
\begin{frame}[label={sec:org3b08b92}]{The Monad Laws}
\begin{align*}
...
\begin{frame}[label={sec:orgf6f33c2}]{First case: quantification}
...
\begin{frame}[label={sec:org36b3145},t]{How it works}
\begin{enumerate}
\item Ashley petted every dog.
\end{enumerate}
...
\begin{frame}[label={sec:orgdd6af3d}]{Summary}
...
\begin{frame}[label={sec:orgecc8774}]{Second case: anaphora}
...
\begin{frame}[label={sec:orge861051},t]{How it works}
\begin{enumerate}
\item Ashley petted herself.
\end{enumerate}
...
\begin{frame}[label={sec:org6fee5e0}]{Summary}
...
\begin{frame}[label={sec:org9f075c6}]{Combining quantification and anaphora}
...
\begin{frame}[label={sec:orgcac60d1}]{Monad transformers}
...
\begin{frame}[label={sec:orgc395a98}]{The Continuation monad transformer}
\begin{columns}
...
\begin{frame}[label={sec:org89844b8}]{The problem}
...
\label{sec:orgf52e706}

\begin{frame}[label={sec:org53699e5}]{We are here}
\tableofcontents[currentsection]
\end{frame}

\begin{frame}[label={sec:org4bc5361}]{Background}
...
\begin{frame}[label={sec:orga679541}]{The basic idea}
...
\begin{frame}[label={sec:org61c69e7}]{Algebraic signatures}
...
\begin{frame}[label={sec:orgb06a9dd}]{Algebraic laws}
